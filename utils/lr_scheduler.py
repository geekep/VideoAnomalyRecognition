"""
LRScheduler function library, most of the code are inspired by MXNet
"""
import logging
...
class MultiFactorScheduler(LRScheduler):
    ...
    def update(self):
        ...
        if self.cursor >= len(self.steps):
            return self.lr
        # print(self.step_counter-1)
        # if (int(self.step_counter) % 100) == 0:
        #     print("Step:",self.step_counter-1,"out of ",self.cursor," steps")
